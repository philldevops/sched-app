        ...
        <View className="flex-1 bg-white px-6" style={{ paddingTop: Constants.statusBarHeight * 2 }}>
            ...
            <View className="space-y-4">
                <TextInput
                    ...
                    className="border border-gray-300 font-RobotoMedium rounded-lg px-4 py-3 text-gray-900"
                />
                <TextInput
                    placeholder="Senha"
                    secureTextEntry
            ...
            <TouchableOpacity className="mt-4" onPress={() => navigation.navigate('ForgotScreen')}>
                <Text className="text-right text-blue-500 font-OutfitBold">Esqueceu sua senha?</Text>
            </TouchableOpacity>

            <TouchableOpacity className="bg-blue-500 mt-6 rounded-lg py-3">
                <Text className="text-center text-white font-OutfitBold text-lg">Entrar</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity className="mt-4" onPress={() => navigation.navigate('RegisterScreen')}>
                <Text className="text-center font-OutfitRegular text-gray-500">
                    ...
                    <Text className="text-blue-500 font-OutfitBold">Cadastre-se</Text>
                </Text>
            </TouchableOpacity>

            <View className="flex-row items-center mt-6">
                <View className="flex-1 h-px bg-gray-300"></View>
                <Text className="px-4 text-gray-500 font-OutfitBold">ou</Text>
                <View className="flex-1 h-px bg-gray-300"></View>
            </View>
            ...
            <TouchableOpacity className="border border-gray-300 mt-6 rounded-lg py-3 flex-row items-center justify-center space-x-2">
                ...
                <Text className="text-gray-900 font-OutfitBold">Entrar com Google</Text>
            </TouchableOpacity>
        </View>
    );
};
